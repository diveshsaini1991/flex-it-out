...
import { ArrowRight, Dumbbell, Heart, Brain, Instagram, Twitter, Facebook, Mail } from 'lucide-react';
...
const Landing = ({ isAuthenticated, darkMode }) => {
  ...
  }, [isStatsInView, isQuoteInView, isServicesInView, statsControls, quoteControls, servicesControls]);
      ...
      drawWaves(context) {
        ...
        for (let i = 0; i < 3; i++) {
          ...
          for (let x = 0; x < this.width; x++) {
            const y = amplitude * Math.sin(x * frequency + this.wavePhase + i) + 
                     this.height * 0.6 + offsetY;
      ...
      >
        ...
        <div className="container mx-auto px-6 z-10 relative">
          ...
          >
            ...
            >
              Join FLEX-IT-OUT, the AI-powered fitness platform that gives you real-time feedback and personalized workout plans.
            </motion.p>
            <motion.button 
            ...
            {[
              {
                ...
                description: "Join our growing community of fitness enthusiasts who are achieving their goals.",
                icon: <Heart size={40} className={darkMode ? "text-red-400" : "text-red-500"} />,
                color: darkMode ? "bg-red-900/20" : "bg-red-50"
              },
              {
                title: "98%",
                subtitle: "Form Accuracy",
                description: "Our AI technology ensures you're performing exercises with proper technique.",
                icon: <Dumbbell size={40} className={darkMode ? "text-blue-400" : "text-blue-500"} />,
                color: darkMode ? "bg-blue-900/20" : "bg-blue-50"
              },
              {
                title: "30%",
                subtitle: "Better Results",
                description: "Users report 30% better results compared to traditional workout methods.",
                icon: <Brain size={40} className={darkMode ? "text-green-400" : "text-green-500"} />,
            ...
            {[
              {
                ...
                description: "Get real-time feedback on your form and technique during exercises.",
                path: "/exercises"
              },
              {
                title: "Personalized Challenges",
                description: "Join challenges tailored to your fitness level and goals.",
                path: "/challenges"
              },
              {
                title: "Community Leaderboard",
                description: "Track your progress and compete with friends to stay motivated.",
                path: "/leaderboard"
              }
            ].map((service, index) => (
              <motion.div 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><motion.button whileHover={{ x: 3 }} onClick={() => handleProtectedNavigate('/home')} className="hover:text-white transition-colors duration-300">Home</motion.button></li>
                <li><motion.button whileHover={{ x: 3 }} onClick={() => handleProtectedNavigate('/profile')} className="hover:text-white transition-colors duration-300">Profile</motion.button></li>
                <li><motion.button whileHover={{ x: 3 }} onClick={() => handleProtectedNavigate('/challenges')} className="hover:text-white transition-colors duration-300">Challenges</motion.button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><motion.a whileHover={{ x: 3 }} href="#" className="hover:text-white transition-colors duration-300">Privacy Policy</motion.a></li>
                <li><motion.a whileHover={{ x: 3 }} href="#" className="hover:text-white transition-colors duration-300">Terms of Service</motion.a></li>
                <li><motion.a whileHover={{ x: 3 }} href="#" className="hover:text-white transition-colors duration-300">FAQ</motion.a></li>
              </ul>
            </div>
