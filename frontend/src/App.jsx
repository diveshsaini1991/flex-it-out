...
import Squat from "./pages/squat.jsx";  
import Landing from "./pages/Landing.jsx"; 
import Crunches from "./pages/Crunches.jsx"; // Import Crunches
import Pushups from "./pages/Pushups.jsx"; // Import Pushups
          ...
          <Routes>
            ...
            {isAuthenticated ? (
              <>
                ...
                <Route path="/exercises" element={<Home darkMode={darkMode} />} />
                <Route path="/squat" element={<Squat darkMode={darkMode} />} />
                <Route path="/crunches" element={<Crunches darkMode={darkMode} />} /> {/* Add Crunches Route */}
                <Route path="/pushups" element={<Pushups darkMode={darkMode} />} /> {/* Add Pushups Route */}
                <Route path="*" element={<Navigate to="/home" />} />
              </>
            ) : (
              <Route path="*" element={<Navigate to="/login" />} />
